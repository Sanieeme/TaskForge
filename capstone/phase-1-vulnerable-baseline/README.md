...
📄 See **[iteration-3-web-app-pentesting/ITERATION3_PENTEST_GUIDE.md](../../iteration-3-web-app-pentesting/ITERATION3_PENTEST_GUIDE.md)**
...
- **ffuf**: enumerate endpoints using `../../iteration-3-web-app-pentesting/wordlist.txt`
...
- **Postman**: import `../../iteration-3-web-app-pentesting/taskforge.postman_collection.json` — pre-built requests for every vulnerability, organized by category
